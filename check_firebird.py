...
def usage():
    ...
    nagios_return('UNKNOWN', 'usage: {0} -h <host> -a <alias> -u <username> -p <password> -d <optional destionport default:3050)'.format(sys.argv[0]))
...
def check_condition(host, destport, alias, username, password):
    # Tries to connect to the given firebird database and
    # execute a SQL statement which should return a list
    # of available tables. Be aware this doesn't work if 
